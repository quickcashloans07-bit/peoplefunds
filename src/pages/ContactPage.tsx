          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 h-full">
                <h3 className="text-xl font-bold mb-8" style={{ color: "hsl(142 76% 22%)", fontFamily: "'Poppins', sans-serif" }}>
                  Contact Information
                </h3>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+18032658598" className="text-gray-500 hover:text-primary transition-colors block mb-1">+1 (803)-265-8598</a>
                      <p className="text-xs text-gray-400">Toll-free, Mon-Fri 8am-8pm EST</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4">
                    <div className="p-3 bg-emerald-50 rounded-2xl" style={{ color: "hsl(142 71% 45%)" }}>
                      <Mail className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Email Support</h4>
                      <a href="mailto:matthewdavis02365@gmail.com" className="text-gray-500 hover:text-primary transition-colors block mb-1">matthewdavis02365@gmail.com</a>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white p-8 md:p-12 rounded-3xl shadow-lg border border-gray-100 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1" 
                     style={{ background: "linear-gradient(90deg, hsl(142 71% 45%), hsl(142 71% 60%))" }} />
                
                <div className="flex items-center gap-3 mb-8">
                  <MessageSquare className="w-6 h-6" style={{ color: "hsl(142 71% 45%)" }} />
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <Button type="submit" disabled={isSubmitting} className="w-full py-6 rounded-xl font-bold text-lg shadow-xl hover:-translate-y-1 transition-transform disabled:opacity-50"
                          style={{ background: "linear-gradient(135deg, hsl(142 76% 22%), hsl(142 76% 15%))", color: "white" }}>
