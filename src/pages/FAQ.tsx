      ...
      <main className="flex-grow">
        <section className="container mx-auto px-4 py-20 max-w-4xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6" style={{ fontFamily: "'Poppins', sans-serif", color: "hsl(142 76% 22%)" }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 relative z-10">
              ...
              <a href="tel:+18032658598">
                <Button variant="outline" className="w-full sm:w-auto px-8 py-6 rounded-xl font-bold border-2 border-white/20 hover:bg-white hover:text-primary transition-colors bg-white/5">
                  <Phone className="w-4 h-4 mr-2" /> +1 (803)-265-8598
                </Button>
              </a>
            </div>
          </div>
