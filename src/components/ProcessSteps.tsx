...
const ProcessSteps = () => {
  return (
    <section className="py-20 md:py-28 bg-primary relative overflow-hidden text-white"
      style={{ background: "linear-gradient(145deg, hsl(142 76% 15%), hsl(142 76% 22%))" }}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black mb-6"
            ...
            Securing Your Funds is <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(142 71% 45%), hsl(142 71% 60%))" }}>Simple</span>
          </h2>
            ...
            <div key={index} className="relative z-10 flex flex-col items-center text-center group">
              <div className="w-28 h-28 rounded-full mb-6 flex items-center justify-center relative transition-transform duration-500 group-hover:-translate-y-2"
                ...
                <div className="absolute -top-1 -right-1 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm shadow-lg"
                  style={{ background: "linear-gradient(135deg, hsl(142 71% 45%), hsl(160 65% 35%))" }}>
                  {index + 1}
                </div>
                <step.icon className="w-10 h-10" style={{ color: "hsl(142 71% 60%)" }} />
              </div>
