...
const testimonials = [  {
    quote: "People Fund made the entire process so easy. I was approved in 15 minutes and the funds were in my account the very next morning. It really saved our family vacation!",
              ...
              <CardContent className="pt-10 pb-8 px-8">
                <div className="flex gap-1 mb-6">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-current" style={{ color: "hsl(142 71% 60%)" }} />
                  ))}
                </div>
