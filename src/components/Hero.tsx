...
const Hero = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative overflow-hidden" style={{ background: "linear-gradient(160deg, hsl(142 76% 12%) 0%, hsl(142 76% 20%) 60%, hsl(220 60% 26%) 100%)" }}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] rounded-full opacity-8"
            style={{ background: "radial-gradient(circle, hsl(142 71% 60%), transparent 70%)" }} />
              ...
              <div className="text-white animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-6"
                  ...
                  <span className="block" style={{
                    background: "linear-gradient(135deg, hsl(142 71% 60%), hsl(142 71% 45%))",
                ...
                <div className="flex flex-wrap gap-4">
                  <Link to="/get-started">
                    <Button
                      ...
                      style={{
                        background: "linear-gradient(135deg, hsl(142 71% 45%), hsl(160 65% 35%))",
                        color: "white",
            ...
            {stats.map((stat, i) => (
              <div key={i} className="py-6 px-8 text-center group hover:bg-emerald-50 transition-colors duration-300">
                <div className="text-3xl font-black mb-1 transition-all"
                  style={{ color: "hsl(142 76% 22%)", fontFamily: "'Poppins', sans-serif" }}>
                  {stat.value}
                </div>
